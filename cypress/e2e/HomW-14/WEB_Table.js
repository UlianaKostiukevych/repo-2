...
function verifyUserForm(userData_1) {
    cy.get(".rt-tr-group:nth-child(4) .rt-td:nth-child(1)").should("have.text", `${userData_1.randomFirstName}`);
    cy.get(".rt-tr-group:nth-child(4) .rt-td:nth-child(2)").should("have.text", `${userData_1.randomLastName}`);
    cy.get(".rt-tr-group:nth-child(4) .rt-td:nth-child(3)").should("have.text", `${userData_1.randomAge}`);
    cy.get(".rt-tr-group:nth-child(4) .rt-td:nth-child(4)").should("have.text", `${userData_1.randomEmail}`);
    cy.get(".rt-tr-group:nth-child(4) .rt-td:nth-child(5)").should("have.text", `${userData_1.randomSalary}`);
    cy.get(".rt-tr-group:nth-child(4) .rt-td:nth-child(6)").should("have.text", `${userData_1.randomDepartment}`);
};

function searchUser(userData_1) {
    cy.get("#searchBox").clear().type(userData_1.randomFirstName);
    cy.get(".rt-tr-group:nth-child(1)").should("contain.text", `${userData_1.randomFirstName}`)
    cy.get("#searchBox").clear().type(userData_1.randomLastName);
    cy.get(".rt-tr-group:nth-child(1)").should("contain.text", `${userData_1.randomLastName}`)
    cy.get("#searchBox").clear().type(userData_1.randomAge);
    cy.get(".rt-tr-group:nth-child(1)").should("contain.text", `${userData_1.randomAge}`)
    cy.get("#searchBox").clear().type(userData_1.randomEmail);
    cy.get(".rt-tr-group:nth-child(1)").should("contain.text", `${userData_1.randomEmail}`)
    cy.get("#searchBox").clear().type(userData_1.randomSalary);
    cy.get(".rt-tr-group:nth-child(1)").should("contain.text", `${userData_1.randomSalary}`)
    cy.get("#searchBox").clear().type(userData_1.randomDepartment);
    cy.get(".rt-tr-group:nth-child(1)").should("contain.text", `${userData_1.randomDepartment}`)
};

function sortColumnByAsc(columnHeaderIndex) {
    cy.get("[role=columnheader]").eq(columnHeaderIndex).click();
    cy.get(`.rt-tr-group .rt-td:nth-child(${columnHeaderIndex + 1})`).then(items => {
